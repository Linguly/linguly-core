...
def add_a_package_to_learning_phrases(user_id: str, goal_id: str, phrase_package_id: str):
    phrase_package = next((pp for pp in phrase_packages if pp.id == phrase_package_id), None)
    ...
    learning_phrases.add_to_learning_phrases(
            user_id, goal_id, phrases, source_id=phrase_package_id, source_type="phrase_package"
        )
